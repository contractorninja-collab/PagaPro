  ...
  return (
    <>
      <div className="hidden md:block">
        <ActionsMenu
          trigger={
            <Button className="h-10 rounded-[10px] bg-brand-blue px-[18px] text-[13.5px] font-semibold text-white shadow-none hover:bg-brand-blue-strong">
              Veprime të Shpejta
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 border-t border-line bg-white/95 p-3 backdrop-blur md:hidden">
        <ActionsMenu
          align="end"
          trigger={
            <Button className="h-10 w-full rounded-[10px] bg-brand-blue text-[13.5px] font-semibold text-white shadow-none hover:bg-brand-blue-strong">
              Veprime të Shpejta
              <ChevronDown className="ml-1 h-4 w-4" aria-hidden />
            </Button>
          }
