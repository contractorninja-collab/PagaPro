...
const CATEGORY_EXTENSIONS: Record<DocumentCategory, PlaceholderDefinition[]> = {
  ...
  LEAVE: [
    ...
    },
    {
      ...
      sources: ["document_metadata"],
      applicableCategories: ["LEAVE"],
      labelSq: "Lloji i pushimit (shqip)",
    },
    {
      key: "leave_subtype_label",
      requiredByDefault: false,
      sources: ["document_metadata"],
      applicableCategories: ["LEAVE"],
      labelSq: "Nën-lloji i pushimit (shqip)",
    },
    {
      key: "leave_status_label",
      requiredByDefault: false,
      sources: ["document_metadata"],
      applicableCategories: ["LEAVE"],
    ...
    },
    {
      ...
      sources: ["document_metadata"],
      applicableCategories: ["LEAVE"],
      labelSq: "Ditë kalendarike të pushimit",
    },
    {
      key: "leave_year",
      requiredByDefault: false,
      sources: ["document_metadata"],
      applicableCategories: ["LEAVE"],
      labelSq: "Viti kalendarik",
    },
    {
      key: "leave_decision_date",
      requiredByDefault: false,
      sources: ["document_metadata"],
      applicableCategories: ["LEAVE"],
    ...
    {
      key: "leave_paid_label",
      requiredByDefault: false,
      sources: ["document_metadata"],
      applicableCategories: ["LEAVE"],
      labelSq: "Me pagesë / pa pagesë",
    },
    {
      key: "leave_quota_days",
      requiredByDefault: false,
      sources: ["document_metadata"],
      applicableCategories: ["LEAVE"],
      labelSq: "Kuota vjetore (ditë)",
    },
    {
      key: "leave_used_days",
      requiredByDefault: false,
      sources: ["document_metadata"],
      applicableCategories: ["LEAVE"],
      labelSq: "Ditë të shfrytëzuara",
    },
    {
      key: "leave_remaining_days",
      requiredByDefault: false,
      sources: ["document_metadata"],
      applicableCategories: ["LEAVE"],
      labelSq: "Ditë të mbetura",
    },
    {
      key: "leave_carry_over_days",
      requiredByDefault: false,
      sources: ["document_metadata"],
      applicableCategories: ["LEAVE"],
      labelSq: "Ditë të bartura",
    },
  ],
  TERMINATION: [
    {
