...
/**
 * Business (customer) data form — used in both the create dialog and the
 * detail edit card. Brand grouping is handled entirely by CompanyGroupTabs on
 * the detail page now, not here.
 */
