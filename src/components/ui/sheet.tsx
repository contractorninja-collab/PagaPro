  ...
  ({ side = "right", className, children, ...props }, ref) => (
    <SheetPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          "fixed z-50 flex h-full w-full max-w-sm flex-col border-border bg-background shadow-lg outline-none data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
          side === "right"
            ? "right-0 top-0 border-l data-[state=closed]:slide-out-to-right-2 data-[state=open]:slide-in-from-right-2"
            : "left-0 top-0 border-r data-[state=closed]:slide-out-to-left-2 data-[state=open]:slide-in-from-left-2",
          className,
        )}
        {...props}
      >
