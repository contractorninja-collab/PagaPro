...
export default function Loading() {
  return (
    <div className="animate-pulse space-y-6 pb-24 md:pb-8" aria-hidden>
      {/* Sub-bar */}
      <div className="-mx-4 border-b border-line bg-white px-4 py-4 md:-mx-8 md:px-8">
        <div className="h-3 w-40 rounded bg-fill-hover" />
      ...
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {[0, 1, 2].map((i) => (
          <div key={i} className="h-[78px] rounded-xl border border-line bg-white" />
        ))}
      </div>

      {/* Filter form */}
      <div className="h-[104px] rounded-xl border border-line bg-white" />
      ...
      <div className="h-[260px] rounded-xl border border-line bg-white" />
      <div className="h-[150px] rounded-xl border border-line bg-white" />
    </div>
  );
}
