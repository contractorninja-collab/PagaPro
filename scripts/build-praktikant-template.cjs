...
function buildBody() {
  ...
  s.push(
    p(
      "Praktikanti/ja pranohet për kryerjen e punës praktike në pozitën {{employee_position}}, me detyrat: {{employee_job_description}}. Kualifikimi: {{employee_qualification}} (neni 11.1.3). Vendi i punës: {{workplace}} (neni 11.1.4). Në pajtim me nenin 16.2 të Ligjit të Punës, praktikanti/ja i realizon të gjitha të drejtat dhe detyrimet nga marrëdhënia e punës sikurse të punësuarit e tjerë, në proporcion me orët e punës (neni 21.3).",
    ),
  );
